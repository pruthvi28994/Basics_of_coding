	...
	public static void main(String[] args) throws IOException {
		...
		try {
			instream = new FileInputStream(
					"C:\\Users\\pruth\\git\\Basics_of_coding\\java_basics\\src\\Advanc_java\\Source.txt");
			outstream = new FileOutputStream(
					"C:\\Users\\pruth\\git\\Basics_of_coding\\java_basics\\src\\Advanc_java\\destination.txt");
			...
			while ((content = instream.read()) != -1) {
				...
				// once done you can see destination file got created and contents are copied
				// from source
			}
		} catch (Exception e) {
		...
		try {
			reader = new FileReader(
					"C:\\Users\\pruth\\git\\Basics_of_coding\\java_basics\\src\\Advanc_java\\Source1.txt");
			writer = new FileWriter(
					"C:\\Users\\pruth\\git\\Basics_of_coding\\java_basics\\src\\Advanc_java\\destination1.txt");
